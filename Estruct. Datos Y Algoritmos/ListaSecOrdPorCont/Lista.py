    ...
    def ListaDefinitiva(self,cabeza1,cabeza2):
        ...
        while aux1 is not None or aux2 is not None:
            ...
            if self.cabeza == None:
                ...
                if aux1 is None:
                    ...
                    if aux1.fila == aux2.fila:
                        if aux1.columna == aux2.columna:
                            ...
                            self.cabeza = Nodo(aux1.fila, aux1.columna, aux1.valor)
                            aux1 = aux1.siguiente
                            print("agrego cabeza 4\n")

                        else:
                            self.cabeza = Nodo(aux2.fila, aux2.columna, aux2.valor)
                            aux2 = aux2.siguiente
                            print("agrego cabeza 5\n")
                                
                    elif aux1.fila < aux2.fila:
                        self.cabeza = Nodo(aux1.fila, aux1.columna, aux1.valor)
                        aux1 = aux1.siguiente
                        print("agrego cabeza 6\n")
                ...
                aux3 =  self.cabeza ## cambie esto que lo estaba asignando en varios lugares
                    ###########################################################
            else:
                ...
                if aux1 is None: ## cambie esto
                    ...
                    if aux1.fila == aux2.fila:
                        if aux1.columna == aux2.columna:
                            aux3.siguiente = Nodo(aux1.fila, aux2.columna, int(aux1.valor) + int(aux2.valor))
                        
                            aux1 = aux1.siguiente ## cambié esto
                            aux2 = aux2.siguiente ## x2
                            repetidos+=1
